...
export function SiteShell({ children }: SiteShellProps) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="sticky top-0 z-40 border-b border-[rgba(10,22,40,0.08)] bg-[#f8f6f1]/72 backdrop-blur-xl dark:border-white/10 dark:bg-[#091120]/70">
        <div className="container-shell flex items-center justify-between gap-4 py-4 sm:gap-6 sm:py-5">
          <Link href="/" className="min-w-0 flex items-center gap-3">
            <div className="flex size-10 shrink-0 items-center justify-center rounded-full border border-primary/45 bg-primary/10 font-heading text-base text-primary sm:size-11 sm:text-lg">
              K2
            </div>
            <div className="min-w-0">
              <div className="truncate text-[11px] uppercase tracking-[0.28em] text-primary sm:text-sm sm:tracking-[0.36em]">
                K2 Digital Media
              </div>
              <div className="hidden text-xs text-foreground/55 sm:block">
                Corporate template boilerplate
              </div>
            </div>
          </Link>
          <div className="flex items-center gap-3">
            ...
            <Sheet>
              ...
              <SheetContent
                side="right"
                className="w-[min(88vw,24rem)] border-l border-[rgba(10,22,40,0.08)] bg-[#f8f6f1]/96 px-0 dark:border-white/10 dark:bg-[#091120]/96"
              >
        ...
        <div className="container-shell grid gap-10 py-10 md:grid-cols-[1.2fr_0.8fr]">
          <div className="max-w-xl">
            ...
            <h2 className="mt-4 text-3xl">
              Built for firms that want gravitas without sacrificing conversion.
            </h2>
          </div>
          <div className="grid gap-4 text-sm text-foreground/68">
            <p>
              Refined luxury aesthetic with a Next.js App Router foundation,
              shadcn primitives, mock admin workflows, and motion-ready sections.
            </p>
            <Link
              href="/admin"
